...
import ZeroCoding from '../lib/zerocoding'
...
describe('ZeroCoding', () => {
    ...
    describe('when the ZeroCoding:open-dapp-studio event is triggered', () => {
        it('hides and shows the modal panel', () => {
            // Before the activation event the view is not on the DOM, and no panel
            // has been created
            expect(workspaceElement.querySelector('.zerocoding')).not.toExist()

            // This is an activation event, triggering it will cause the package to be
            // activated.
            atom.commands.dispatch(workspaceElement, 'ZeroCoding:open-dapp-studio')
            ...
            runs(() => {
                expect(workspaceElement.querySelector('.zerocoding')).toExist()

                let zeroCodingElement = workspaceElement.querySelector('.zerocoding')
                expect(zeroCodingElement).toExist()
